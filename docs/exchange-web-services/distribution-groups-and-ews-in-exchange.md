...
---
# <a name="distribution-groups-and-ews-in-exchange"></a>Groupes de distribution et les services EWS d’Exchange
...
|:-----|:-----|:-----|
|Boîte aux lettres  <br/> |Boîte aux lettres  <br/> |Un objet Active Directory à extension messagerie.  <br/> |
