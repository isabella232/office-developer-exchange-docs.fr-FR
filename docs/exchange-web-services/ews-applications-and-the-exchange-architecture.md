...
- Authentification de jeton OAuth 2.0, pour les applications partenaires approuvées et l'interopérabilité avec Lync Server 2013 et SharePoint Server 2013.
