...
L’élément **AcceptItem** représente une réponse accepter à une demande de réunion. 
...
Le schéma qui décrit cet élément se trouve dans le répertoire EWS du serveur Exchange sur lequel le rôle serveur d’accès au client est installé.
