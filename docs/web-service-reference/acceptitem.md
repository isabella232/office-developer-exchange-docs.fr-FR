...
description: L’élément AcceptItem représente une réponse Accept à une demande de réunion.
ms.openlocfilehash: 0cdf68f13d9c10e80f61b01c711f3686b9f63d60
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: fr-FR
ms.lasthandoff: 09/24/2021
ms.locfileid: "59540335"
---
# <a name="acceptitem"></a>AcceptItem

**L’élément AcceptItem** représente une réponse Accept à une demande de réunion. 
...
Le schéma qui décrit cet élément se trouve dans le répertoire EWS du serveur Exchange sur qui le rôle serveur d’accès au client est installé.
