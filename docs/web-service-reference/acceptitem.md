...
L’élément **AcceptItem** représente une réponse accepter une demande de réunion. 
...
Le schéma qui décrit cet élément se trouve dans le répertoire EWS du serveur Exchange qui a le rôle de serveur d’accès au Client est installé.
