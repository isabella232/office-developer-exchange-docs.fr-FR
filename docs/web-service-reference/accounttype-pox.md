...
La valeur de texte représente le type de compte. La valeur possible est un **courrier électronique**, ce qui indique les paramètres pour un serveur de messagerie. 
