...
|[SentToAddresses](senttoaddresses.md) <br/> |Contient une liste d’adresses de messagerie à qui les messages entrants doivent avoir été envoyés afin que la condition ou l’exception s’applique.  <br/> |
