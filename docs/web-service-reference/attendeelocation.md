...
L’élément **AttendeeLocation** spécifie l’emplacement d’un participant pour un élément de calendrier. 
...
|**Élément**|**Description**|
|:-----|:-----|
|[LocationBasedStateDefinition](locationbasedstatedefinition.md) <br/> |Spécifie l’État lorsqu’il est basé sur l’emplacement.  <br/> |
   
## <a name="text-value"></a>Valeur texte

La valeur de texte de l’élément AttendeeLocation est l’emplacement obligatoires.
