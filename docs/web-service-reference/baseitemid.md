...
L’élément **BaseItemId** représente la classe de base pour les identificateurs qui représentent des éléments dans une boîte aux lettres. Ceci est une classe abstraite et par conséquent, ne se produit pas dans une instance de document. 
