...
Un deuxième [élément Bias](bias.md) du schéma représente le décalage par rapport au décalage UTC (Temps universel coordonné). 
  
## <a name="example"></a>Exemple

L’exemple suivant montre une partie d’une demande XML qui identifie un décalage de 8 heures par rapport à l’heure UTC sur l’application cliente.
