...
L’élément **BillingInformation** contient les informations de facturation d’une tâche. 
...
La valeur texte représente les informations de facturation liées à une tâche.
