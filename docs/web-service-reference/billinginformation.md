...
L’élément **BillingInformation** conserve des informations de facturation pour une tâche. 
...
La valeur de texte représente les informations de facturation liées aux tâches.
