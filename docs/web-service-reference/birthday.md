...
---
# <a name="birthday"></a>Anniversaire

L’élément **Anniversaire** représente la date de naissance d’un contact. 
...
Une valeur de texte qui représente une date et une heure est requise.
