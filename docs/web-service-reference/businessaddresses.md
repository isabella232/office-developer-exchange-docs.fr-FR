...
L’élément **BusinessAddresses** spécifie un tableau d’adresses professionnelles et les identificateurs de leurs attributions sources pour le personnage associé. 
