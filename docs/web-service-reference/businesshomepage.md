...
L’élément **BusinessHomePage** représente la page d’accueil (adresse Web) pour le contact. 
...
La valeur de texte représente un identificateur uniform resource identifier (URI) pour la page d’accueil.
