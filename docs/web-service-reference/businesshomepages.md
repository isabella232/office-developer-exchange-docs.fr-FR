...
L’élément **BusinessHomePages** spécifie un tableau de pages d’accueil business et les identificateurs de leurs attributions source pour le personnage associé. 
