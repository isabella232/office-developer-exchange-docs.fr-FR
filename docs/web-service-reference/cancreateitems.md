...
Une valeur de texte de **la valeur true** indique que l’utilisateur peut créer des éléments dans le dossier. La valeur **false** indique que l’utilisateur ne peut pas créer des éléments dans le dossier. 
