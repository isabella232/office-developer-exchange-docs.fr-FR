...
L’élément **CarPhone** spécifie un tableau de numéros de téléphone de voiture et les identificateurs de leurs attributions sources pour le personnage associé. 
