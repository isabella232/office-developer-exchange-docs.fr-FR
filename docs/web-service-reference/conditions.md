...
|[ContainsHeaderStrings](containsheaderstrings.md) <br/> |Indique les chaînes qui doivent apparaître dans les en-têtes des messages entrants afin que la condition ou l’exception s’applique.  <br/> |
