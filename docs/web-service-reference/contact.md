...
|[FileAs](fileas.md) <br/> |Indique comment un contact est classé dans le dossier Contacts.  <br/> |
...
|[GivenName](givenname.md) <br/> |Contient le nom d’un contact donné.  <br/> |
...
|[SpouseName](spousename.md) <br/> |Représente le nom du conjoint d’un contact.  <br/> |
...
|Nom du schéma  <br/> |Types de schéma  <br/> |
...
[Création de Contacts (Services Web Exchange)](http://msdn.microsoft.com/library/4845917e-70d1-481c-bbd7-011ec6571789%28Office.15%29.aspx)
