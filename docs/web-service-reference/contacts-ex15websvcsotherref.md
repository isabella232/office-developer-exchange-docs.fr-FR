...
L’élément de **Contacts** contient une liste des contacts qui sont associés à une tâche. 
...
|**Élément**|**Description**|
|:-----|:-----|
|[String](string.md) <br/> |Représente une liste séparée par des virgules des noms de contacts.  <br/> |
