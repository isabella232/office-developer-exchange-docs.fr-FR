...
L’élément **ContactSource** indique si le contact se trouve dans la banque Exchange ou les Services de domaine Active Directory (AD DS). 
...
Les valeurs possibles de cet élément sont les suivantes :
