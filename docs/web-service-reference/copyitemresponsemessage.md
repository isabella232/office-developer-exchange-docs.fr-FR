...
description: L’élément CopyItemResponseMessage contient l’état et le résultat d’une demande d’opération CopyItem unique.
...
**L’élément CopyItemResponseMessage** contient l’état et le résultat d’une demande d’opération [CopyItem](copyitem-operation.md) unique. 
...
|:-----|:-----|
|**ResponseClass** <br/> | Décrit l’état [d’une réponse d’opération CopyItem.](copyitem-operation.md)<br/><br/>Les valeurs suivantes sont valides pour cet attribut :<br/><br/>- Réussite  <br/>- Avertissement  <br/>- Erreur  <br/> |
