...
L’élément **CreateAttachmentResponseMessage** contient l’État et le résultat d’une seule demande d' [opération CreateAttachment](createattachment-operation.md) . 
...
> [!NOTE]
> Si plusieurs pièces jointes sont attachées à un élément en un seul aller-retour, l’attribut **RootItemChangeKey** dans le dernier message de réponse est celui qui représente la nouvelle clé de modification de l’élément contenant les pièces jointes. 
