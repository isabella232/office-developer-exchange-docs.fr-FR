...
description: L’élément CreateFolderResponseMessage contient l’état et le résultat d’une demande d’opération CreateFolder unique.
...
**L’élément CreateFolderResponseMessage** contient l’état et le résultat d’une [demande d’opération CreateFolder](createfolder-operation.md) unique. 
...
|:-----|:-----|
|**ResponseClass** <br/> | Décrit l’état [d’une réponse d’opération CreateFolder.](createfolder-operation.md)<br/><br/>Les valeurs suivantes sont valides pour cet attribut :<br/><br/>- Réussite  <br/>- Avertissement  <br/>- Erreur  <br/> |
...
|[Dossiers](folders-ex15websvcsotherref.md) <br/> |Contient un tableau de dossiers créés.  <br/> |
