...
Une demande CreateItem l’exemple suivant montre comment créer un nouveau message électronique, envoyer le message et enregistrer une copie dans le dossier Brouillons.
...
Pour trouver d’autres options pour le message de demande de l’opération CreateItem, explorez la hiérarchie de schéma. Commencer à l’élément [CreateItem](createitem.md) . 
...
Pour trouver d’autres options pour le message de réponse de l’opération CreateItem, explorez la hiérarchie de schéma. Démarrez au niveau de l’élément [CreateItemResponse](createitemresponse.md) . 
  
## <a name="error-createitem-response"></a>Réponse d’erreur CreateItem
