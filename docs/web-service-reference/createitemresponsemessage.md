...
description: L’élément CreateItemResponseMessage contient l’état et le résultat d’une demande d’opération CreateItem unique.
ms.openlocfilehash: 0495cb5ac9a4f749cb1e6a69360023b43ade7954
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: fr-FR
ms.lasthandoff: 09/24/2021
ms.locfileid: "59511873"
---
# <a name="createitemresponsemessage"></a>CreateItemResponseMessage

**L’élément CreateItemResponseMessage** contient l’état et le résultat d’une demande [d’opération CreateItem](createitem-operation.md) unique. 
...
|:-----|:-----|
|**ResponseClass** <br/> | Décrit l’état d’une [réponse d’opération CreateItem.](createitem-operation.md)<br/><br/>Les valeurs suivantes sont valides pour cet attribut :<br/><br/>- Réussite  <br/>- Avertissement  <br/>- Erreur  <br/> |
...
|[Items](items.md) <br/> |Contient un tableau d’éléments créés.  <br/> |
