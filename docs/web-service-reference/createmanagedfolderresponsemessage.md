...
L’élément **CreateManagedFolderResponseMessage** contient l’état et les résultats d’une seule demande [d’opération CreateManagedFolder](createmanagedfolder-operation.md) . 
...
|:-----|:-----|
|**ResponseClass** <br/> | Décrit l’état d’une réponse de [l’opération CreateManagedFolder](createmanagedfolder-operation.md) .<br/><br/>Les valeurs suivantes sont valides pour cet attribut :<br/><br/>-Réussite  <br/>-Avertissement  <br/>-Erreur  <br/> |
...
|[Dossiers](folders-ex15websvcsotherref.md) <br/> |Contient un tableau des dossiers gérés créés.  <br/> |
