...
L’élément **DateTimeReceived** représente la date et l’heure à laquelle un élément dans une boîte aux lettres a été reçu. 
...
La valeur de text représente l’heure à laquelle un élément est reçu dans une boîte aux lettres. Cette propriété est en lecture seule.
