...
L’élément **DeleteUserConfiguration** représente une demande pour supprimer un objet de configuration utilisateur. 
...
|**Élément**|**Description**|
|:-----|:-----|
|[UserConfigurationName](userconfigurationname.md) <br/> |Représente le nom de l’objet de configuration d’utilisateur à supprimer.  <br/> |
