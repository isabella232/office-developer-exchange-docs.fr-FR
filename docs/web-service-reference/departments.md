...
---
# <a name="departments"></a>Comptabilité

L’élément **Departments** spécifie un tableau de noms de service et les identificateurs de leurs attributions sources pour le personnage associé. 
