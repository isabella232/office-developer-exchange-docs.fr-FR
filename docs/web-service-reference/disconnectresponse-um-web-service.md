...
L’élément **DisconnectResponse** définit une réponse à une [opération de déconnexion (service Web de messagerie unifiée)](disconnect-operation-um-web-service.md) . 
