...
---
# <a name="disconnectresponse-um-web-service"></a>DisconnectResponse (service web de messagerie unifiée)

L’élément **DisconnectResponse** définit une réponse à une demande de [l’opération de déconnexion (service web de messagerie unifiée)](disconnect-operation-um-web-service.md) . 
