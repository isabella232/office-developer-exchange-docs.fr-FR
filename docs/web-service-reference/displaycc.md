...
L’élément **DisplayCc** représente la chaîne d’affichage qui est utilisée pour le contenu de la zone CC. Il s'agit de la chaîne concaténée de tous les noms d'affichage de destinataires Cc. 
...
La valeur de texte représente la chaîne d’affichage qui est utilisée pour le contenu de la zone CC.
