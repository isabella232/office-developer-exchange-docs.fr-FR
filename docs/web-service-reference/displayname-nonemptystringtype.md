...
L’élément **DisplayName** contient le nom complet d’un contact de groupe ou le nom complet d’un nouveau groupe de messagerie instantané de la messagerie instantanée. 
...
La valeur de texte de l’élément **DisplayName** est le nom complet d’un contact de groupe ou le nom complet d’un nouveau groupe de messagerie instantané de la messagerie instantanée. 
