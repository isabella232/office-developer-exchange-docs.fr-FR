...
L’élément **DisplayName (VotingOptionDataType)** spécifie le nom d’affichage d’une option de vote. 
...
La valeur de texte de l’élément **DisplayName (VotingOptionDataType)** est le nom d’affichage d’une option de vote. 
