...
L’élément **DisplayNameLastFirstHeader** Spécifie l’en-tête pour le nom complet, nom tout d’abord. 
...
La valeur de texte de l’élément **DisplayNameLastFirstHeader** est une valeur de type string qui spécifie le nom complet, nom de famille tout d’abord. 
