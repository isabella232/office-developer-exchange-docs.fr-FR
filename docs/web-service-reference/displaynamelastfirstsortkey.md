...
L’élément **DisplayNameLastFirstSortKey** contient la clé de tri pour un nom d’affichage dans le nom de famille, prénom. 
...
La valeur de texte de l’élément **DisplayNameLastFirstSortKey** est la clé de tri pour le nom d’un personnage dans le nom de famille, prénom. 
