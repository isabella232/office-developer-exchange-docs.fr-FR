...
L’élément **DisplayNamePrefix** spécifie le préfixe du nom d’affichage du personnage associé. 
...
La valeur de texte de l’élément **DisplayNamePrefix** est une valeur de type String qui spécifie le préfixe du nom d’affichage. 
