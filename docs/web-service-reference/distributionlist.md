...
|**Élément**|**Description**|
|:-----|:-----|
|[MimeContent](mimecontent.md) <br/> |Contient le flux MIME natif d’un objet représenté dans le format base64Binary.  <br/> |
|[ID d’élément](itemid.md) <br/> |Contient la clé unique identificateur et modification d’un élément de liste de distribution dans la banque d’informations Exchange.  <br/> |
...
|[Sensitivity](sensitivity.md) <br/> |Contient l’état de la sensibilité d’un élément de liste de distribution.  <br/> |
|[Corps](body.md) <br/> |Représente le contenu du corps d’un élément de liste de distribution.  <br/> |
|[Pièces jointes](attachments-ex15websvcsotherref.md) <br/> |Contient les éléments ou les fichiers associés à un élément de liste de distribution dans la banque d’informations Exchange.  <br/> |
|[DateTimeReceived](datetimereceived.md) <br/> |Représente la date et l’heure à laquelle un élément de liste de distribution dans une boîte aux lettres a été reçu.  <br/> |
|[Size](size.md) <br/> |Représente la taille, en octets, d’un élément de liste de distribution. Cette propriété est en lecture seule.  <br/> |
|[Categories](categories-ex15websvcsotherref.md) <br/> |Représente une collection de chaînes qui identifient les catégories appartient un élément de liste de distribution dans la boîte aux lettres.  <br/> |
|[Importance](importance.md) <br/> |Décrit l’importance d’un élément de liste de distribution.  <br/> |
|[InReplyTo](inreplyto.md) <br/> |Représente l’identificateur de l’élément de cet élément est une réponse.  <br/> |
...
|[ExtendedProperty](extendedproperty.md) <br/> |Identifie les propriétés étendues sur un élément de liste de distribution.  <br/> |
|[Culture](culture.md) <br/> |Représente la culture pour un élément de liste de distribution dans une boîte aux lettres.  <br/> |
...
|[Classer sous](fileas.md) <br/> |Représente la façon dont une liste de distribution est présentée dans le dossier Contacts.  <br/> |
|[ContactSource](contactsource.md) <br/> |Indique si le contact se trouve dans la banque Exchange ou dans les Services de domaine Active Directory (AD DS).  <br/> |
...
|[AppendToItemField](appendtoitemfield.md) <br/> |Identifie les données à ajouter à une propriété d’une liste de distribution pendant une [opération UpdateItem](updateitem-operation.md).  <br/> |
...
|[Créer (ItemSync)](create-itemsync.md) <br/> |Identifie une liste de distribution à créer dans le magasin du client local.  <br/> |
|[Mise à jour (ItemSync)](update-itemsync.md) <br/> |Identifie une liste de distribution pour mettre à jour dans le magasin de client local.  <br/> |
...
|[SetItemField](setitemfield.md) <br/> |Représente une mise à jour d’une propriété d’un élément de liste de distribution dans une [opération UpdateItem](updateitem-operation.md).  <br/> |
