...
L’élément **DomainSetting** contient les paramètres de domaine qui sont renvoyées par la requête d’opération [GetDomainSettings opération (SOAP)](getdomainsettings-operation-soap.md) . 
