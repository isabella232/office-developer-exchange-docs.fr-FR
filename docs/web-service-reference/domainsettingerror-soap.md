...
L’élément **DomainSettingError** représente une erreur qui s’est produite lors de la récupération d’un paramètre de domaine. Cela représente une erreur à partir d’une demande **GetDomainSettings** . 
...
|[Propriétés SettingName (SOAP)](settingname-soap.md) <br/> |Représente le nom du paramètre.  <br/> |
