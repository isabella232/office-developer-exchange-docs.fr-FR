...
L’élément **EcpUrl-tmCreating** spécifie une URL partielle qui peut être combinée avec la valeur de l’élément [EcpUrl (POX)](ecpurl-pox.md) pour générer une URL qui peut être utilisée pour créer une nouvelle boîte aux lettres de site. 
...
La valeur de texte représente une URL partielle qui peut être combinée avec la valeur de l’élément [EcpUrl (POX)](ecpurl-pox.md) pour générer une URL qui peut être utilisée pour créer une nouvelle boîte aux lettres de site. 
  
## <a name="remarks"></a>Remarques

L’élément **EcpUrl-tmCreating** est un élément enfant facultatif de l’élément **Protocol** . 
