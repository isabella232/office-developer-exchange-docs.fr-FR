...
description: L’élément EmailAddresses spécifie un tableau de toutes les adresses de messagerie de la personne associée.
ms.openlocfilehash: d52bd83cd6f83b5004d1fb5d7aeb536a8fc4323c
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: fr-FR
ms.lasthandoff: 09/24/2021
ms.locfileid: "59525084"
---
# <a name="emailaddresses-arrayofemailaddressestype"></a>EmailAddresses (ArrayOfEmailAddressesType)

**L’élément EmailAddresses** spécifie un tableau de toutes les adresses de messagerie de la personne associée. 
