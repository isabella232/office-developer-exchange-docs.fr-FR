...
L’élément **EmptyFolderResponseMessage** contient l’état et les résultats d’une seule demande [EmptyFolder](emptyfolder.md) . 
...
|:-----|:-----|
|**ResponseClass** <br/> | Décrit l’état d’une réponse de [l’opération EmptyFolder](emptyfolder-operation.md) .<br/><br/>Les valeurs suivantes sont valides pour cet attribut :<br/><br/>-Réussite  <br/>-Avertissement  <br/>-Erreur  <br/> |
