...
description: L’élément EndTimeZone définit le fuseau horaire pour l’heure de fin d’un CalendarItem ou d’un MeetingRequest.
ms.openlocfilehash: 6d34afdedfb8e4886526317afea6abc324bde3c8
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: fr-FR
ms.lasthandoff: 09/24/2021
ms.locfileid: "59520695"
---
# <a name="endtimezone"></a>EndTimeZone

**L’élément EndTimeZone** définit le fuseau horaire pour l’heure de fin d’un [CalendarItem](calendaritem.md) ou [MeetingRequest](meetingrequest.md).
