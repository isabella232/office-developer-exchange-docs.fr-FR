...
L’élément **ErrorCode** contient le code d’erreur pour une erreur de réponse de découverte automatique. 
...
La valeur de texte représente le code d’erreur pour une erreur de réponse de découverte automatique.
