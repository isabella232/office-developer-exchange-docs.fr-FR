...
L’élément **ErrorMessage** contient le message d’erreur qui explique pourquoi un élément n’est pas indexable. 
...
La valeur de texte de l’élément **ErrorMessage** est un message d’erreur qui explique pourquoi un élément n’est pas indexable. 
