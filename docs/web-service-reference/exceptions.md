...
|[ContainsHeaderStrings](containsheaderstrings.md) <br/> |Indicaqtes les chaînes qui doivent apparaître dans les en-têtes des messages entrants afin que l’exception ou la condition à appliquer.  <br/> |
...
Les prédicats de règle sont utilisées comme conditions de règle ou exceptions.
