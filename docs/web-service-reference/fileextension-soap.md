...
|**Élément**|**Description**|
|:-----|:-----|
|[SupportedFileExtensions (SOAP)](supportedfileextensions-soap.md) <br/> |Contient une liste des extensions de fichiers dans un emplacement de partage de documents.  <br/> |
