...
description: L’élément FindFolderResponseMessage contient l’état et le résultat d’une demande d’opération FindFolder unique.
ms.openlocfilehash: 68472b6452af7e9593dfe894353ecd28babe2e21
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: fr-FR
ms.lasthandoff: 09/24/2021
ms.locfileid: "59530520"
---
# <a name="findfolderresponsemessage"></a>FindFolderResponseMessage

**L’élément FindFolderResponseMessage** contient l’état et le résultat d’une demande d’opération [FindFolder](findfolder-operation.md) unique. 
...
|:-----|:-----|
|**ResponseClass** <br/> | Décrit l’état d’une [réponse d’opération FindFolder.](findfolder-operation.md)<br/><br/> Les valeurs suivantes sont valides pour cet attribut :  <br/><br/>- Réussite  <br/>- Avertissement  <br/>- Erreur  <br/> |
...
|[RootFolder (FindFolderResponseMessage)](rootfolder-findfolderresponsemessage.md) <br/> |Contient les résultats d’une recherche d’un dossier racine unique au cours [d’une opération FindFolder](findfolder-operation.md).  <br/> |
