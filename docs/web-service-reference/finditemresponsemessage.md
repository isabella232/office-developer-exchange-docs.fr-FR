...
L’élément **FindItemResponseMessage** contient l’État et le résultat d’une seule demande d' [opération FindItem](finditem-operation.md) . 
...
|:-----|:-----|
|**ResponseClass** <br/> | Décrit l’état d’une réponse d' [opération FindItem](finditem-operation.md) .<br/><br/> Les valeurs suivantes sont valides pour cet attribut : <br/> <br/>-Réussite  <br/>-AVERTISSEMENT  <br/>-Erreur  <br/> |
