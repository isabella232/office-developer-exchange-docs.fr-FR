...
L’élément **FindMessageTrackingReportResponse** contient l’état et les résultats d’une seule demande [d’opération FindMessageTrackingReport](findmessagetrackingreport-operation.md) . 
...
|[Diagnostics](diagnostics.md) <br/> |Contient des informations qui seront utilisées pour générer des rapports de statistiques différentes pour la fonctionnalité de suivi dans un centre de données.  <br/> |
|[MessageTrackingSearchResults](messagetrackingsearchresults.md) <br/> |Contient les tableau des messages qui correspondent à la configuration requise de recherche.  <br/> |
|[ExecutedSearchScope](executedsearchscope.md) <br/> |Contient l’étendue de la recherche a été effectuée pour obtenir les résultats de recherche.  <br/> |
