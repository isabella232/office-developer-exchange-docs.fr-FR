...
- [<span data-ttu-id="cbf1b-158">RoutingType (EmailAddressType)</span><span class="sxs-lookup"><span data-stu-id="cbf1b-158">RoutingType (EmailAddressType)</span></span>](routingtype-emailaddresstype.md)
