...
L’élément **ForwardAllowed** indique si le transfert de courriers électroniques est activée. 
...
Une valeur de texte de **la valeur true** pour l’élément **ForwardAllowed** indique que le transfert de courriers électroniques est autorisée. La valeur **false** indique que le transfert n’est pas autorisé. 
