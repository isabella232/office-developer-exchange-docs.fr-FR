...
description: L’élément GetClientIntentResponseMessage est destiné à un usage interne uniquement.
...
**L’élément GetClientIntentResponseMessage** est destiné à un usage interne uniquement. 
