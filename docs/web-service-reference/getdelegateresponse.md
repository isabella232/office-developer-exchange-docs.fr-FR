...
|**Élément**|**Description**|
|:-----|:-----|
|[DeliverMeetingRequests](delivermeetingrequests.md) <br/> |Définit la façon dont les demandes de réunion sont gérées entre le délégué et le principal.  <br/> |
