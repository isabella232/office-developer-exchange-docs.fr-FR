...
L’élément **GetDelegateResponse** contient l’État et le résultat d’une demande d' [opération GetDelegate](getdelegate-operation.md) . 
...
|**Élément**|**Description**|
|:-----|:-----|
|[DeliverMeetingRequests](delivermeetingrequests.md) <br/> |Définit la manière dont les demandes de réunion sont gérées entre le délégué et le principal.  <br/> |
