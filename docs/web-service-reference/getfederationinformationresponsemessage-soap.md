...
L’élément **GetFederationInformationResponseMessage** définit une réponse à une demande [SOAP (GetFederationInformation Operation)](getfederationinformation-operation-soap.md) . 
