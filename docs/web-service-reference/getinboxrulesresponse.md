...
|:-----|:-----|
|**ResponseClass** <br/> | Décrit l’état d’une réponse de [l’opération GetInboxRules](getinboxrules-operation.md) . <br/><br/>Les valeurs suivantes sont valides pour cet attribut : <br/> <br/>-Réussite  <br/>-Avertissement  <br/>-Erreur  <br/> |
...
|[OutlookRuleBlobExists](outlookruleblobexists.md) <br/> |Indique si un objet blob règle de Microsoft Outlook existe dans la boîte aux lettres de l’utilisateur.  <br/> |
|[InboxRules](inboxrules.md) <br/> |Représente un tableau des règles de boîte aux lettres de l’utilisateur.  <br/> |
