...
L’élément **GetOrganizationRelationshipSettingsRequest** représente les paramètres d’un appel à l’opération [GetOrganizationRelationshipSettings (SOAP)](getorganizationrelationshipsettings-operation-soap.md) . L’élément **GetOrganizationRelationshipSettingsRequest** est à usage interne uniquement. Cet élément n’est pas utilisé par les clients. 
