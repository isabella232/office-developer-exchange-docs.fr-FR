...
L’élément **GetOrganizationRelationshipSettingsResponseMessage** définit une réponse à une demande de [l’opération GetOrganizationRelationshipSettings (SOAP)](getorganizationrelationshipsettings-operation-soap.md) . L’élément **GetOrganizationRelationshipSettingsResponseMessage** est à usage interne uniquement. Cet élément n’est pas utilisé par les clients. 
