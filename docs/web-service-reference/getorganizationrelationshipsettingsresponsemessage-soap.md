...
L’élément **GetOrganizationRelationshipSettingsResponseMessage** définit une réponse à une demande [SOAP (GetOrganizationRelationshipSettings Operation)](getorganizationrelationshipsettings-operation-soap.md) . L’élément **GetOrganizationRelationshipSettingsResponseMessage** est réservé à un usage interne. Cet élément n’est pas utilisé par les clients. 
