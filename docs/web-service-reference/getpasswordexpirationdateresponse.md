...
|:-----|:-----|
|[PasswordExpirationDate](passwordexpirationdate.md) <br/> |Indique la date d’expiration du mot de passe pour le compte de messagerie spécifié dans la demande.  <br/> |
