...
description: L’élément GetRoomListsResponse définit la réponse d’une demande d’opération GetRoomLists.
ms.openlocfilehash: 4b8eb3cc596debd1110849ac10edaed9308708f3
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: fr-FR
ms.lasthandoff: 09/24/2021
ms.locfileid: "59518301"
---
# <a name="getroomlistsresponse"></a>GetRoomListsResponse

**L’élément GetRoomListsResponse** définit la réponse d’une demande d’opération [GetRoomLists.](getroomlists-operation.md) 
...
|[RoomLists](roomlists.md) <br/> |Fournit une liste des adresses de messagerie et des noms d’affichage qui représentent des listes de salles de réunion.  <br/> |
