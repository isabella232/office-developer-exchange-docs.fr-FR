...
|**Élément**|**Description**|
|:-----|:-----|
|[SearchableMailboxes](searchablemailboxes.md) <br/> |Contient un tableau des boîtes aux lettres renvoyées par une **demande GetSearchableMailboxes.**  <br/> |
