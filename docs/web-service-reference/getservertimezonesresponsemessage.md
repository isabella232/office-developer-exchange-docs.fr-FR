...
L’élément **GetServerTimeZonesResponseMessage** contient l’état et les résultats d’une seule demande [d’opération GetServerTimeZones](getservertimezones-operation.md) . 
...
|[TimeZoneDefinitions](timezonedefinitions.md) <br/> |Contient un tableau des définitions de fuseau horaire.  <br/> |
