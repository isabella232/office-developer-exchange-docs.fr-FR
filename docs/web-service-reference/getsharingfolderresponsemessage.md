...
L’élément **GetSharingFolderResponseMessage** contient l’État et le résultat d’une seule demande d' [opération GetSharingFolder](getsharingfolder-operation.md) . 
