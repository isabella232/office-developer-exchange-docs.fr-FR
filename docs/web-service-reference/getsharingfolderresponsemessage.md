...
description: L’élément GetSharingFolderResponseMessage contient l’état et le résultat d’une demande d’opération GetSharingFolder unique.
ms.openlocfilehash: 6eb95ea779b003021cd51a4fa31a8d30440da21b
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: fr-FR
ms.lasthandoff: 09/24/2021
ms.locfileid: "59515830"
---
# <a name="getsharingfolderresponsemessage"></a>GetSharingFolderResponseMessage

**L’élément GetSharingFolderResponseMessage** contient l’état et le résultat d’une demande d’opération [GetSharingFolder](getsharingfolder-operation.md) unique. 
