...
description: L’élément GetSharingMetadataResponseMessage contient l’état et le résultat d’une demande d’opération GetSharingMetadata unique.
...
**L’élément GetSharingMetadataResponseMessage** contient l’état et le résultat d’une demande d’opération [GetSharingMetadata](getsharingmetadata-operation.md) unique. 
...
|[EncryptedSharedFolderDataCollection](encryptedsharedfolderdatacollection.md) <br/> |Contient une collection de structures de données qu’un client peut utiliser pour autoriser le partage de ses données de calendrier ou de contact avec d’autres clients.  <br/> |
|[InvalidRecipients](invalidrecipients.md) <br/> |Représente les destinataires de la demande de partage de dossier qui ne sont pas valides.  <br/> |
