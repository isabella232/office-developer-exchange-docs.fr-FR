...
L’élément **GetSharingMetadataResponseMessage** contient l’état et les résultats d’une seule demande [d’opération GetSharingMetadata](getsharingmetadata-operation.md) . 
