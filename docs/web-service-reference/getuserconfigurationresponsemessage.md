...
L’élément **GetUserConfigurationResponseMessage** représente une réponse qui renvoie un objet de configuration utilisateur. 
...
|[UserConfiguration](userconfiguration.md) <br/> |Contient un objet de configuration utilisateur unique.  <br/> |
