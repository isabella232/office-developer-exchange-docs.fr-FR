...
L’élément **GetUserConfigurationResponseMessage** représente une réponse qui renvoie un objet configuration de l’utilisateur. 
...
|[UserConfiguration](userconfiguration.md) <br/> |Contient un seul objet Configuration utilisateur.  <br/> |
