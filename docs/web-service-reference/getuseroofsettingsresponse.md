...
L’élément **GetUserOofSettingsResponse** contient le message de réponse et les paramètres d’absence du bureau (OOF) pour un utilisateur. 
...
|[OofSettings](oofsettings.md) <br/> |Contient les paramètres d’absence du bureau.  <br/> |
|[AllowExternalOof](allowexternaloof.md) <br/> |Contient une valeur qui identifie les messages d’absence du bureau externes qui sont envoyés.  <br/> |
