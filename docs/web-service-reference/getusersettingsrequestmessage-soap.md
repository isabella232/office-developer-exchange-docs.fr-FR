...
L’élément **GetUserSettingsRequestMessage** représente une demande [SOAP (GetUserSettings Operation)](getusersettings-operation-soap.md) . 
...
|**Élément**|**Description**|
|:-----|:-----|
|[Demande (SOAP)](request-soap.md) <br/> |Contient les paramètres de configuration demandés.  <br/> |
