...
---
# <a name="group-mailboxassociationtype"></a>Groupe (MailboxAssociationType)

L’élément **Group (MailboxAssociationType)** est destiné à une utilisation interne uniquement. 
