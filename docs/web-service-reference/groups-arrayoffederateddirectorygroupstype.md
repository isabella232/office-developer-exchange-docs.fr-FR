...
---
# <a name="groups-arrayoffederateddirectorygroupstype"></a>Groupes (ArrayOfFederatedDirectoryGroupsType)

L’élément **Groups (ArrayOfFederatedDirectoryGroupsType)** est destiné à une utilisation interne uniquement. 
