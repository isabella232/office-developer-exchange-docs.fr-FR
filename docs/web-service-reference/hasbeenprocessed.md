...
L’élément **HasBeenProcessed** indique si un message de réunion élément a été traité. 
...
Une valeur de texte de **la valeur true** indique que le message de réunion a été traité. 
