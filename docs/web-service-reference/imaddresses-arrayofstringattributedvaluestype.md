...
description: L’élément ImAddresses spécifie un tableau d’adresses de message instantané et les identificateurs de leurs attributions source pour le personnage associé.
ms.openlocfilehash: 11ac1c6da39693565fad9da10a1a410e46608359
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: fr-FR
ms.lasthandoff: 09/24/2021
ms.locfileid: "59525814"
---
# <a name="imaddresses-arrayofstringattributedvaluestype"></a>ImAddresses (ArrayOfStringAttributedValuesType)

**L’élément ImAddresses** spécifie un tableau d’adresses de message instantané et les identificateurs de leurs attributions source pour le personnage associé. 
