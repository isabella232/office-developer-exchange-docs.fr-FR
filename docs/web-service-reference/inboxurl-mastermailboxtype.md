...
description: L’élément InboxUrl (MasterMailboxType) est destiné à un usage interne uniquement.
...
**L’élément InboxUrl (MasterMailboxType)** est destiné à un usage interne uniquement. 
