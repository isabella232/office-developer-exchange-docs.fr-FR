...
L’élément **IndividualAttendeeConflictData** contient l’utilisateur ou le statut de disponibilité du contact pour une fenêtre de temps qui se produit en même temps que l’heure de réunion proposée identifié dans l’élément [Suggestion](suggestion.md) . 
...
|**Élément**|**Description**|
|:-----|:-----|
|[BusyType](busytype.md) <br/> |Représente l’état de disponibilité d’un utilisateur pour une heure de réunion proposée.  <br/> |
