...
L’élément **InternalId** représente une valeur entière pour l’identification de l’événement. 
...
Une valeur de texte qui représente un entier est requise si cet élément est utilisé.
