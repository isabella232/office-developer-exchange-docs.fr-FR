...
ms.locfileid: "59514577"
---
# <a name="internetmessageid"></a>InternetMessageId

**L’élément InternetMessageId représente** l’identificateur de message Internet d’un élément. 
...
La valeur de texte représente l’identificateur de message Internet.
