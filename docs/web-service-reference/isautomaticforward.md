...
L’élément **IsAutomaticForward** indique si les messages entrants doivent être des transferts automatiques afin que l’exception ou la condition à appliquer. 
...
Texte la valeur **true** indique que le message doit être un transfert automatique afin que l’exception ou la condition à appliquer. La valeur **false** indique que le message ne doit pas être un transfert automatique afin que l’exception ou la condition à appliquer. 
