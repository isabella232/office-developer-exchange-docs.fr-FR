...
description: L’élément IsContactPhoto indique si la pièce jointe du fichier est une image de contact.
ms.openlocfilehash: a20c81997e15e310b795bc8f346b06a5c3147e9f
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: fr-FR
ms.lasthandoff: 09/24/2021
ms.locfileid: "59539513"
---
# <a name="iscontactphoto"></a>IsContactPhoto

**L’élément IsContactPhoto** indique si la pièce jointe du fichier est une image de contact. 
