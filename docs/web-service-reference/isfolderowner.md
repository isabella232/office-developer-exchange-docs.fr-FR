...
Une valeur de texte de **la valeur true** indique que l’utilisateur est le propriétaire du dossier. La valeur **false** indique que l’utilisateur n’est pas le propriétaire du dossier. 
