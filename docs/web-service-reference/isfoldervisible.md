...
Une valeur de texte de **la valeur true** indique que l’utilisateur peut afficher le dossier. La valeur **false** indique que l’utilisateur ne peut pas afficher le dossier. 
