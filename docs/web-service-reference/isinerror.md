...
L’élément **IsInError** indique si la règle est dans une condition d’erreur. 
...
Une valeur de texte **true** indique que la règle est dans une condition d’erreur. La valeur **false** indique que la règle ne se trouve pas dans une condition d’erreur. 
