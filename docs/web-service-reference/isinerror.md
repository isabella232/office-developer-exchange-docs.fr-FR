...
L’élément **IsInError** indique si la règle est une condition d’erreur. 
...
Une valeur de texte de **la valeur true** indique que la règle est une condition d’erreur. La valeur **false** indique que la règle n’est pas une condition d’erreur. 
