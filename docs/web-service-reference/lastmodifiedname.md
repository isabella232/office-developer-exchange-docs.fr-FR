...
L’élément **LastModifiedName** contient le nom d’affichage du dernier utilisateur qui a modifié un élément. Cet élément est en lecture seule. Cet élément a été introduit dans Microsoft Exchange Server 2007 Service Pack 1 (SP1). 
...
La valeur de texte est une valeur de chaîne qui représente le nom d’affichage du dernier utilisateur qui a modifié l’élément.
