...
---
# <a name="mailboxes-arrayofstringstype"></a>Boîtes aux lettres (ArrayOfStringsType)

L’élément de **boîtes aux lettres** contient une liste des boîtes aux lettres affectées par le blocage. 
