...
L’élément **MailTipsAccessEnabled** représente l’indicateur **MailTipsAccessEnabled ()** . L’élément **MailTipsAccessEnabled** est réservé à un usage interne. Cet élément n’est pas utilisé par les clients. 
