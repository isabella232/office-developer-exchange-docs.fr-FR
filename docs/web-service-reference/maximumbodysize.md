...
L’élément **MaximumBodySize** spécifie la taille maximale du corps d’élément à renvoyer dans une réponse. 
...
La valeur de texte de l’élément **MaximumBodySize** indique la taille maximale de la propriété [Body](body.md) retournée dans la réponse. Cela est exprimée en kilo-octets. 
