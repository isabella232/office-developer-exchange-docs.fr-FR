...
La valeur de texte est un entier qui représente la taille maximale des messages d’un destinataire peut accepter. Cette valeur peut être exprimée en kilo-octets ou en mégaoctets.
