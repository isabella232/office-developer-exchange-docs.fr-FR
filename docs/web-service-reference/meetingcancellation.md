...
L’élément **MeetingCancellation** représente une annulation de réunion dans la Banque d’aide Exchange. 
...
|[ReminderMinutesBeforeStart](reminderminutesbeforestart.md) <br/> |Représente le nombre de minutes avant l’affichage d’un rappel.  <br/> |
