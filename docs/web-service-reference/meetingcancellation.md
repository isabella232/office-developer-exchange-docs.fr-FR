...
L’élément **MeetingCancellation** représente une annulation de réunion dans la banque d’informations Exchange. 
...
|[ReminderMinutesBeforeStart](reminderminutesbeforestart.md) <br/> |Représente le nombre de minutes avant un événement d’affichage d’un rappel.  <br/> |
