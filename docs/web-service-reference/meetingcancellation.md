...
description: L’élément MeetingCancellation représente une annulation de réunion dans Exchange store.
...
**L’élément MeetingCancellation** représente une annulation de réunion dans le Exchange store. 
...
|[ReminderMinutesBeforeStart](reminderminutesbeforestart.md) <br/> |Représente le nombre de minutes avant l’affichage d’un rappel d’un événement.  <br/> |
