...
|[MeetingRequestType](meetingrequesttype.md) <br/> |Décrit le type de demande de réunion.  <br/> |
|[IntendedFreeBusyStatus](intendedfreebusystatus.md) <br/> |Représente l’état prévu pour l’élément de calendrier associé à la demande de réunion.  <br/> |
...
|[When](when.md) <br/> |Fournit une description du moment où une réunion a lieu.  <br/> |
...
|[ModifiedOccurrences](modifiedoccurrences.md) <br/> |Contient un tableau d’occurrences d’éléments de calendrier périodiques qui ont été modifiées afin qu’elles soient différentes de l’élément maître de récurrence.  <br/> Cet élément est valide si [CalendarItemType](calendaritemtype.md) a la valeur RecurringMaster.  <br/> |
...
|[AllowNewTimeProposal](allownewtimeproposal.md) <br/> |Représente si une nouvelle heure de réunion peut être proposée pour une réunion.  <br/> |
...
|[NetShowUrl](netshowurl.md) <br/> |Spécifie l’URL d’une réunion en ligne Microsoft Nethow.  <br/> |
