...
Le **Message** contient le message d’erreur pour une erreur de réponse de découverte automatique. 
...
La valeur de texte représente le message d’erreur pour l’erreur de réponse de découverte automatique.
