...
L’élément **MinorBuildNumber** représente le numéro de version secondaire pour le serveur. 
...
Une valeur entière qui représente le mineur numéro de build du serveur qui a traité la demande.
