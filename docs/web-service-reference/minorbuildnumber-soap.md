...
L’élément **MinorBuildNumber** représente un numéro de build mineur pour le serveur. 
...
Valeur entière qui représente le numéro de version mineure du serveur qui a traité la demande.
