...
L’élément **MinorVersion** représente le numéro de version secondaire pour le serveur. 
...
Valeur entière qui représente le numéro de version secondaire du serveur qui a traité la demande.
