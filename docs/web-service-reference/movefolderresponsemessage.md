...
L’élément **MoveFolderResponseMessage** contient l’État et le résultat d’une seule demande d' [opération MoveFolder](movefolder-operation.md) . 
