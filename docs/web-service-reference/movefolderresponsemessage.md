...
description: L’élément MoveFolderResponseMessage contient l’état et le résultat d’une demande d’opération MoveFolder unique.
...
**L’élément MoveFolderResponseMessage** contient l’état et le résultat d’une demande d’opération [MoveFolder](movefolder-operation.md) unique. 
...
|:-----|:-----|
|**ResponseClass** <br/> | Décrit l’état d’une [réponse d’opération MoveFolder.](movefolder-operation.md) <br/><br/>Les valeurs suivantes sont valides pour cet attribut :  <br/><br/>- Réussite  <br/>- Avertissement  <br/>- Erreur  <br/> |
...
|**Élément**|**Description**|
|:-----|:-----|
|[MessageText](messagetext.md) <br/> |Description textuelle de l’état de la réponse.  <br/> |
...
|[Dossiers](folders-ex15websvcsotherref.md) <br/> |Contient un tableau de dossiers déplacés.  <br/> |
