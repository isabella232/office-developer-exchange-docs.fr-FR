...
L’élément **NumberOfOccurrences** contient le nombre d’occurrences d’un élément périodique. 
...
La valeur de texte est un entier qui représente le nombre d’occurrences d’un élément périodique. La valeur doit être un entier compris entre 1 et 999.
