...
L’élément **OutlookRuleBlobExists** indique si un objet blob règle de Microsoft Outlook existe dans la boîte aux lettres de l’utilisateur. 
...
Une valeur de texte de **la valeur true** indique qu’un blob de règle Outlook existe. Texte la valeur **false** indique qu’un blob de règle Outlook n’existe pas. 
