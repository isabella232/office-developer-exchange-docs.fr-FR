...
L’élément **OutlookRuleBlobExists** indique si un objet blob de règle Microsoft Outlook existe dans la boîte aux lettres de l’utilisateur. 
...
Une valeur de texte **true** indique qu’un objet blob de règle Outlook existe. Une valeur de texte **false** indique qu’un objet blob de règle Outlook n’existe pas. 
