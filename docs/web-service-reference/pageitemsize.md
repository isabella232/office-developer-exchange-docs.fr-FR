...
L’élément **PageItemSize** spécifie le nombre d’éléments à renvoyer dans une pagination des résultats de la recherche. 
...
La valeur de texte de l’élément **PageItemSize** est le nombre d’éléments renvoyés dans une pagination de résultat de recherche. 
