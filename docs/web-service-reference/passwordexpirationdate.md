...
ms.locfileid: "59534822"
---
# <a name="passwordexpirationdate"></a>PasswordExpirationDate

**L’élément PasswordExpirationDate fournit** la date d’expiration du mot de passe pour un compte de boîte aux lettres. 
...
|:-----|:-----|
|[Opération GetPasswordExpirationDate](getpasswordexpirationdate-operation.md) <br/> |Définit une demande d’obtenir la date d’expiration du mot de passe d’un compte de messagerie.  <br/> |
