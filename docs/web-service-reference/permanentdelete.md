...
Une valeur de **texte true** indique que le message doit être marqué pour être définitivement supprimé. La valeur **false indique** que le message ne doit pas être marqué pour être définitivement supprimé. 
