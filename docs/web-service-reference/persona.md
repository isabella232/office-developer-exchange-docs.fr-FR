...
---
# <a name="persona"></a><span data-ttu-id="f4371-103">Personnage</span><span class="sxs-lookup"><span data-stu-id="f4371-103">Persona</span></span>

<span data-ttu-id="f4371-104">L’élément **personnage** spécifie un ensemble de données personnage renvoyées par une demande **GetPersona** .</span><span class="sxs-lookup"><span data-stu-id="f4371-104">The **Persona** element specifies a set of persona data returned by a **GetPersona** request.</span></span> 
