...
---
# <a name="persona"></a><span data-ttu-id="c4e9e-103">Persona</span><span class="sxs-lookup"><span data-stu-id="c4e9e-103">Persona</span></span>

<span data-ttu-id="c4e9e-104">L’élément **Persona** spécifie un ensemble de données Persona renvoyées par une demande **GetPersona** .</span><span class="sxs-lookup"><span data-stu-id="c4e9e-104">The **Persona** element specifies a set of persona data returned by a **GetPersona** request.</span></span> 
