...
L’élément **PhoneNumbers** représente une collection de numéros de téléphone pour un contact. 
...
|**Élément**|**Description**|
|:-----|:-----|
|[Entrée (PhoneNumber)](entry-phonenumber.md) <br/> |Représente un numéro de téléphone pour un contact.  <br/> |
