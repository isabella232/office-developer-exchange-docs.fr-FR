...
L’élément **PhoneticFullName** contient le nom complet d’un contact, y compris son prénom et son nom, orthographié phonétiquement. 
...
La valeur de texte est une chaîne qui représente le nom complet d’un contact, y compris son prénom et son nom, orthographié phonétiquement.
