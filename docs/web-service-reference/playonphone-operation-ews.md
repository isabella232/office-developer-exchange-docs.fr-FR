...
L’exemple suivant **d’une demande PlayOnPhone** montre comment former une demande de lecture d’un message sur un téléphone. 
...
L’exemple suivant montre une réponse réussie à la **demande PlayOnPhone.** 
