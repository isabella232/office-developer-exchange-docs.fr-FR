...
L’élément **PostalCode** représente le code postal d’un élément de contact. 
...
La valeur de texte est une valeur de chaîne qui représente le code postal d’un contact.
