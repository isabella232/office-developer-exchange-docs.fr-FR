...
---
# <a name="postalcode"></a>Code postal

L’élément **PostalCode** représente le code postal pour un élément de contact. 
...
La valeur de texte est une valeur de type string qui représente le code postal du contact.
