...
---
# <a name="postitem"></a>Objet postItem

L’élément **PostItem** représente un élément de publication dans la banque d’informations Exchange. 
...
|[HasAttachments](hasattachments.md) <br/> |Représente une propriété qui est définie sur **true** si un élément a au moins une pièce jointe. Cette propriété est en lecture seule.  <br/> |
...
|[From](from.md) <br/> |Représente l’adresse à partir de laquelle l’élément de message a été envoyé. L’élément **à partir de** peut uniquement être définie au moment de la création.  <br/> |
...
|[PostedTime](postedtime.md) <br/> |Représente l’heure à laquelle un [objet PostItem](postitem.md) a été validée.  <br/> |
|[References](references.md) <br/> |Représente l’en-tête Usenet qui est utilisé pour associer des réponses avec les messages d’origine.  <br/> |
...
|[ReadFlagChange](readflagchange.md) <br/> |Renvoyées dans les réponses [SyncFolderItems](syncfolderitems.md) lorsqu’un élément a été lu. Cette propriété est en lecture seule. Cet élément a été introduit dans Exchange 2007 SP1.  <br/> |
