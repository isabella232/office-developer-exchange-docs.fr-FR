...
description: L’élément PostItem représente un élément de publication dans la Exchange store.
ms.openlocfilehash: 1d30c64482e4dbf9731141c3f5f2b30e4b9f9e5f
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: fr-FR
ms.lasthandoff: 09/24/2021
ms.locfileid: "59516432"
---
# <a name="postitem"></a>PostItem

**L’élément PostItem** représente un élément de publication dans la Exchange store. 
...
|[HasAttachments](hasattachments.md) <br/> |Représente une propriété définie sur **true** si un élément a au moins une pièce jointe. Cette propriété est en lecture seule.  <br/> |
...
|[From](from.md) <br/> |Représente l’adresse à partir de laquelle l’élément de publication a été envoyé. **L’élément From** ne peut être définie qu’au moment de la création.  <br/> |
...
|[PostedTime](postedtime.md) <br/> |Représente l’heure de publication [d’un postItem.](postitem.md)  <br/> |
|[Références](references.md) <br/> |Représente l’en-tête Usenet utilisé pour associer les réponses aux messages d’origine.  <br/> |
...
|[ReadFlagChange](readflagchange.md) <br/> |Renvoyé dans [les réponses SyncFolderItems](syncfolderitems.md) lorsqu’un élément a été lu. Cette propriété est en lecture seule. Cet élément a été introduit dans Exchange 2007 SP1.  <br/> |
