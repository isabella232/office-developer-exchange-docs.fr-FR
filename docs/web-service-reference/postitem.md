...
L’élément **PostItem** représente un élément post dans la Banque d’Exchange. 
...
|[From](from.md) <br/> |Représente l’adresse à partir de laquelle l’élément a été envoyé. L’élément **from** ne peut être défini qu’au moment de la création.  <br/> |
...
|[PostedTime](postedtime.md) <br/> |Représente l’heure à laquelle un [PostItem](postitem.md) a été publié.  <br/> |
|[References](references.md) <br/> |Représente l’en-tête Usenet qui est utilisé pour associer les réponses aux messages d’origine.  <br/> |
...
|[ReadFlagChange](readflagchange.md) <br/> |Renvoyée dans les réponses [SyncFolderItems](syncfolderitems.md) lorsqu’un élément a été lu. Cette propriété est en lecture seule. Cet élément a été introduit dans Exchange 2007 SP1.  <br/> |
