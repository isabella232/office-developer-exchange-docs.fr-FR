...
|[Categories](categories-ex15websvcsotherref.md) <br/> |Représente une collection de chaînes qui identifient les catégories auxquelles appartient un élément dans la boîte aux lettres.  <br/> |
...
|[HasAttachments](hasattachments.md) <br/> |Représente une propriété qui est définie sur **true** si un élément comportant une pièce jointe. Cette propriété est en lecture seule.  <br/> |
...
|[References](references.md) <br/> |Représente l’en-tête Usenet qui sert à associer des réponses à leurs messages d’origine.  <br/> |
...
|**Élément**|**Description**|
|:-----|:-----|
|[AdjacentMeetings](adjacentmeetings.md) <br/> |Décrit tous les éléments qui sont adjacentes à une heure de réunion.  <br/> |
