...
|[RoutingType (EmailAddress)](routingtype-emailaddress.md) <br/> |Représente le protocole de routage de ce destinataire. La valeur par défaut est SMTP. Cet élément est facultatif.  <br/> |
