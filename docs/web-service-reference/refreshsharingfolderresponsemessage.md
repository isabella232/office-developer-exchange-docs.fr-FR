...
L’élément **RefreshSharingFolderResponseMessage** contient l’État et le résultat d’une seule demande d' [opération RefreshSharingFolder](refreshsharingfolder-operation.md) . 
