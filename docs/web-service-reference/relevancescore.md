...
L’élément **RelevanceScore** spécifie un entier qui représente comment le personnage associé correspond au client. 
...
La valeur de texte de l’élément **RelevanceScore** est la détermination est un personnage comment pertinents pour le client. Cet élément est en lecture seule. 
