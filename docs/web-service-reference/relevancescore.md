...
L’élément **RelevanceScore** spécifie un entier qui représente la manière dont le personnage associé est pertinent pour le client. 
...
La valeur de texte de l’élément **RelevanceScore** est la détermination du degré de pertinence d’un personnage pour le client. Cet élément est en lecture seule. 
