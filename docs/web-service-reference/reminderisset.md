...
L’élément **ReminderIsSet** indique si un rappel a été défini pour un élément dans la Banque d’information Exchange. 
...
Une valeur de texte **true** indique qu’un rappel a été défini. 
