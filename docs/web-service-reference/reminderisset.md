...
L’élément **ReminderIsSet** indique si un rappel a été défini pour un élément dans la banque d’informations Exchange. 
...
Une valeur de texte de **la valeur true** indique qu’un rappel a été défini. 
