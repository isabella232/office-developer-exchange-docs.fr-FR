...
description: Trouvez des informations sur l’opération RemoveImContactFromGroup EWS.
ms.openlocfilehash: 696e05bfa12f3ddd0c9d7bfca4a58368ee115c2b
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: fr-FR
ms.lasthandoff: 09/24/2021
ms.locfileid: "59512414"
---
# <a name="removeimcontactfromgroup-operation"></a>Opération RemoveImContactFromGroup

Trouvez des informations sur **l’opération RemoveImContactFromGroup** EWS. 
  
**L’opération RemoveImContactFromGroup supprime** un contact de messagerie instantanée unique d’un groupe de messagerie instantanée. 
  
Cette opération est une nouveauté d’Exchange Server 2013.
  
## <a name="using-the-removeimcontactfromgroup-operation"></a>Utilisation de l’opération RemoveImContactFromGroup

**L’opération RemoveImContactFromGroup** prend deux arguments : un identificateur d’élément de contact et le groupe de messagerie instantanée correspondant duquel le contact est supprimé. 
...
## <a name="removeimcontactfromgroup-operation-request-example"></a>Exemple de demande d’opération RemoveImContactFromGroup

L’exemple suivant **d’une demande d’opération RemoveImContactFromGroup** montre comment supprimer un contact de messagerie instantanée d’un groupe de messagerie instantanée. 
...
## <a name="removeimcontactfromgroup-operation-errorinvalidimcontactid-error-response"></a>Réponse d’erreur errorInvalidImContactId de l’opération RemoveImContactFromGroup

L’exemple suivant montre une réponse d’erreur à une demande d’opération **RemoveImContactFromGroup.** La réponse d’erreur suivante se produit lorsqu’une tentative de suppression d’un élément de contact qui n’existe pas dans le groupe de messagerie instantanée est tentée. 
