...
L’élément **RequestedConfiguration** contient les configurations de service demandées. 
...
|**Élément**|**Description**|
|:-----|:-----|
|[ConfigurationName](configurationname.md) <br/> |Spécifie les configurations de service demandées par nom.  <br/> |
