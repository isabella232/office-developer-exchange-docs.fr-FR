...
L’élément **ResponseMessages** contient les messages de réponse pour une demande de Services Web Exchange. 
...
|[EmptyFolderResponseMessage](emptyfolderresponsemessage.md) <br/> |Contient l’état et les résultats d’une seule demande [EmptyFolder](emptyfolder.md) .  <br/> |
...
|[UploadItemsResponseMessage](uploaditemsresponsemessage.md) <br/> |Contient l’état et les résultats d’une requête UploadItems.  <br/> |
|[ExportItemsResponseMessage](exportitemsresponsemessage.md) <br/> |Contient l’état et les résultats d’une requête ExportItems.  <br/> |
...
|[GetStreamingEventsResponseMessage](getstreamingeventsresponsemessage.md) <br/> |Contient l’état et les résultats d’une requête GetStreamingEvents.  <br/> |
...
|[UpdateUserConfigurationResponseMessage](updateuserconfigurationresponsemessage.md) <br/> |Contient l’état et les résultats d’une requête UpdateUserConfiguration.  <br/> |
...
|[GetServerTimeZonesResponseMessage](getservertimezonesresponsemessage.md) <br/> |Contient l’état et les résultats d’une requête GetServerTimeZones.  <br/> |
...
|**Élément**|**Description**|
|:-----|:-----|
|[CopyFolderResponse](copyfolderresponse.md) <br/> |Définit une réponse à une demande de CopyFolder.  <br/> |
|[CopyItemResponse](copyitemresponse.md) <br/> |Définit une réponse à une demande de CopyItem.  <br/> |
|[CreateAttachmentResponse](createattachmentresponse.md) <br/> |Définit une réponse à une demande CreateAttachment.  <br/> |
|[CreateFolderResponse](createfolderresponse.md) <br/> |Définit une réponse à une demande de CreateFolder.  <br/> |
...
|[ExpandDLResponse](expanddlresponse.md) <br/> |Définit une réponse à une demande de ExpandDL.  <br/> |
|[ExportItemsResponse](exportitemsresponse.md) <br/> |Représente la réponse à une demande ExportItems unique.  <br/> |
...
|[GetStreamingEventsResponse](getstreamingeventsresponse.md) <br/> |Définit une réponse à une demande de GetStreamingEvents.  <br/> |
|[GetFolderResponse](getfolderresponse.md) <br/> |Définit une réponse à une demande GetFolder.  <br/> |
|[GetItemResponse](getitemresponse.md) <br/> |Définit une réponse à une demande de GetItem.  <br/> |
...
|[SendNotificationResult](sendnotificationresult.md) <br/> |Définit une réponse à une demande de SendNotification.  <br/> |
|[SubscribeResponse](subscriberesponse.md) <br/> |Définit une réponse à la demande Subscribe.  <br/> |
...
|[UpdateFolderResponse](updatefolderresponse.md) <br/> |Définit une réponse à une demande de UpdateFolder.  <br/> |
|[UpdateItemResponse](updateitemresponse.md) <br/> |Définit une réponse à une demande de UpdateItem.  <br/> |
|[ConvertIdResponse](convertidresponse.md) <br/> |Contient une réponse à une demande de ConvertId.  <br/> |
|[GetServerTimeZonesResponse](getservertimezonesresponse.md) <br/> |Définit une réponse à une demande de GetServerTimeZones.  <br/> |
|[CreateUserConfigurationResponse](createuserconfigurationresponse.md) <br/> |Définit une réponse à une demande de CreateUserConfiuration.  <br/> |
|[DeleteUserConfigurationResponse](deleteuserconfigurationresponse.md) <br/> |Définit une réponse à une demande de DeleteUserConfiguration.  <br/> |
|[GetUserConfigurationResponse](getuserconfigurationresponse.md) <br/> |Définit une réponse à une demande de GetUserConfiguration.  <br/> |
|[UpdateUserConfigurationResponse](updateuserconfigurationresponse.md) <br/> |Définit une réponse à une demande de UpdateUserConfiguration.  <br/> |
...
|[GetPasswordExpirationDateResponse](getpasswordexpirationdateresponse.md) <br/> |Définit une réponse à une demande d’opération [GetPasswordExpirationDate opération](getpasswordexpirationdate-operation.md) .  <br/> |
