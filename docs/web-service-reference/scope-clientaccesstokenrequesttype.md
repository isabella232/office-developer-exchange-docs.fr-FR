...
L’élément de **portée (ClientAccessTokenRequestType)** spécifie une étendue de jeton. 
...
La valeur de texte de l’élément **d’étendue (ClientAccessTokenRequestType)** est une jeton étendue. 
