...
L’élément **Scope (ClientAccessTokenRequestType)** spécifie une portée de jeton. 
...
La valeur de texte de l’élément **Scope (ClientAccessTokenRequestType)** est une portée de jeton. 
