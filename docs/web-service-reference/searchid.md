...
ms.locfileid: "59543988"
---
# <a name="searchid"></a>SearchId

**L’élément SearchId** spécifie l’identificateur d’une recherche de découverte. 
...
La valeur de texte de **l’élément SearchId** est l’identificateur de recherche de découverte. 
