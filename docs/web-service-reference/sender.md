...
L’élément **sender** identifie l’expéditeur d’un élément. 
...
|**Élément**|**Description**|
|:-----|:-----|
|[Boîte aux lettres](mailbox.md) <br/> |Identifie un objet Active Directory à extension messagerie qui identifie l’expéditeur.  <br/> |
