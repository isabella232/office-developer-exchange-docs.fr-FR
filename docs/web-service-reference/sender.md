...
L’élément de **l’expéditeur** identifie l’expéditeur d’un élément. 
...
|**Élément**|**Description**|
|:-----|:-----|
|[Boîte aux lettres](mailbox.md) <br/> |Identifie un objet Active Directory de messagerie qui identifie l’expéditeur.  <br/> |
