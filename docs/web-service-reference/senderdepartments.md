...
L’élément **SenderDepartments** indique que le service de l’expéditeur correspond à l’un des services spécifiés dans les éléments de [valeur (ProtectionRuleValueType)](value-protectionrulevaluetype.md) enfants. 
...
|**Élément**|**Description**|
|:-----|:-----|
|[Valeur (ProtectionRuleValueType)](value-protectionrulevaluetype.md) <br/> |Identifie un service unique de l’expéditeur.  <br/> |
