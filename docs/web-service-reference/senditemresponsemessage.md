...
description: L’élément SendItemResponseMessage contient l’état et le résultat d’une demande d’opération SendItem unique.
...
**L’élément SendItemResponseMessage** contient l’état et le résultat d’une demande d’opération [SendItem](senditem-operation.md) unique. 
...
|:-----|:-----|
|**ResponseClass** <br/> | Décrit l’état d’une [réponse d’opération SendItem.](senditem-operation.md) <br/><br/>Les valeurs suivantes sont valides pour cet attribut : <br/> <br/>- Réussite  <br/>- Avertissement  <br/>- Erreur  <br/> |
