...
L’élément **SendNotification** contient les notifications de type transmission envoyées par l’ordinateur qui exécute Microsoft Exchange Server 2007 vers l’application cliente. 
...
|**Élément**|**Description**|
|:-----|:-----|
|[ResponseMessages](responsemessages.md) <br/> |Contient les notifications de type transmission envoyées par le serveur d’accès au client.  <br/> |
