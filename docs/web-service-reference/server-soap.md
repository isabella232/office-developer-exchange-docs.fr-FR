...
L’élément **serveur** représente le serveur de boîtes aux lettres de substitution. 
...
La valeur de texte de l’élément **serveur** est le nom du serveur de boîtes aux lettres de substitution. 
