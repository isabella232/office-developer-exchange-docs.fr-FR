...
description: L’élément ServerHint représente le point de départ pour le suivi d’un message dans un site distant ou une forêt.
...
**L’élément ServerHint** représente le point de départ pour le suivi d’un message dans un site distant ou une forêt. 
