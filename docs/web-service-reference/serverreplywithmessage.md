...
L’élément **ServerReplyWithMessage** indique l’ID de modèle de message qui doit être envoyé en réponse aux messages entrants. 
...
|**Élément**|**Description**|
|:-----|:-----|
|[ID d’élément](itemid.md) <br/> |Représente la clé unique identificateur et modification d’un élément dans la banque d’informations Exchange.  <br/> |
