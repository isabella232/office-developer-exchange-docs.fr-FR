...
description: L’élément SetTeamMailbox contient une demande de définir une boîte aux lettres de site.
ms.openlocfilehash: 99b6edb891c593d7f686fbe1bceb1c0668d9251e
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: fr-FR
ms.lasthandoff: 09/24/2021
ms.locfileid: "59540474"
---
# <a name="setteammailbox"></a>SetTeamMailbox

**L’élément SetTeamMailbox contient** une demande de définir une boîte aux lettres de site. 
