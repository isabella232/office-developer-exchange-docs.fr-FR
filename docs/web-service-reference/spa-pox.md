...
La valeur texte indique si SPA est requis. Si la valeur du texte est **activée**, Spa est requis.
  
## <a name="remarks"></a>Remarques

Si cet élément n’est pas présent, la valeur par défaut est définie **sur on**.
