...
|[CalendarEvent](calendarevent.md) <br/> |Représente une occurrence d’élément de calendrier unique. Cette information est utilisée pour les demandes de disponibilité. L’élément **StartTime** est requis dans l’élément **CalendarEvent** . L’élément **StartTime** de l’élément **CalendarEvent** est propre au type **CalendarEvent** , bien qu’il contienne les mêmes valeurs de facette que les éléments **StartTime** du type **Duration** .  <br/><br/> Voici l’expression XPath de cet élément :  <br/> <br/> `/GetUserAvailabilityResponse/FreeBusyResponseArray/FreeBusyResponse/FreeBusyView/CalendarEventArray/CalendarEvent[i]` <br/> |
...
Le schéma comprend de nombreux éléments [StartTime](starttime.md) . 
