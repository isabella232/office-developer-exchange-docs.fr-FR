...
---
# <a name="street"></a>Avenue

L’élément **Street** représente une adresse postale pour un contact. 
...
La valeur de texte est une chaîne qui représente l’adresse postale d’un contact.
