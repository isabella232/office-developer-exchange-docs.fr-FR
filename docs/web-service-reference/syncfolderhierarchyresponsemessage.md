...
L’élément **SyncFolderHierarchyResponseMessage** contient l’État et le résultat d’une seule demande d' [opération opérationsyncfolderhierarchy](syncfolderhierarchy-operation.md) . 
...
|:-----|:-----|
|**ResponseClass** <br/> | Décrit l’état d’une réponse d' [opération opérationsyncfolderhierarchy](syncfolderhierarchy-operation.md) . <br/><br/>Les valeurs suivantes sont valides pour cet attribut :<br/>  <br/>-Réussite  <br/>-AVERTISSEMENT  <br/>-Erreur  <br/> |
...
|[Changes (hiérarchie)](changes-hierarchy.md) <br/> |Contient un tableau de séquence de types de modifications qui représentent les types de différences entre les éléments sur le client et les éléments sur le serveur Exchange.  <br/> |
