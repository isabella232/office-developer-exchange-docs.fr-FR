...
L’élément **TargetSharingEpr** représente la propriété **TargetSharingEpr** . L’élément **TargetSharingEpr** est réservé à un usage interne. Cet élément n’est pas utilisé par les clients. 
