...
L’élément de **tâche** représente une tâche dans la banque d’informations Exchange. 
...
|[Sensitivity](sensitivity.md) <br/> |Contient l’état de la sensibilité d’un élément.  <br/> |
...
|[La propriété ActualWork](actualwork.md) <br/> |Représente la valeur effective de temps passé sur une tâche.  <br/> |
|[AssignedTime](assignedtime.md) <br/> |Représente le temps lorsqu’une tâche est affectée à un contact.  <br/> |
|[BillingInformation](billinginformation.md) <br/> |Contient les informations pour une tâche de facturation.  <br/> |
...
|[Personne](delegator.md) <br/> |Contient le nom de la personne qui a attribué la tâche.  <br/> |
|[DueDate](duedate.md) <br/> |Représente la date à laquelle un élément de tâche est due.  <br/> |
|[IsAssignmentEditable](isassignmenteditable.md) <br/> |Indique si la tâche est modifiable ou non.  <br/> |
|[Avertisse](iscomplete.md) <br/> |Indique si la tâche est terminée ou non.  <br/> |
...
|[Mileage](mileage.md) <br/> |Représente le mileage pour un élément de tâche.  <br/> |
|[Propriétaire](owner.md) <br/> |Représente le propriétaire d’une tâche.  <br/> |
...
|[Date de début](startdate.md) <br/> |Représente la date de début d’un élément de tâche.  <br/> |
...
|[TotalWork](totalwork.md) <br/> |Contient une description de la quantité de travail est associé à un élément.  <br/> |
