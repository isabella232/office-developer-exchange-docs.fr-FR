...
L’élément **TotalWork** contient une description de la quantité de travail est associé à une tâche. 
...
La valeur de texte correspond à un entier qui représente la quantité totale de travail qui est associé à une tâche.
