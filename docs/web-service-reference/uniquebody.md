...
L’élément **UniqueBody** représente un fragment HTML ou du texte brut qui représente le corps de cette conversation unique. 
...
|:-----|:-----|
|**BodyType** <br/> |Décrit la façon dont le corps de l’élément est stocké dans l’élément.  <br/> |
