...
description: L’élément UniqueUnreadSenders contient une liste de toutes les personnes qui ont envoyé des messages actuellement non lus dans cette conversation dans le dossier actuel. Cet élément est en lecture seule.
...
**L’élément UniqueUnreadSenders** contient une liste de toutes les personnes qui ont envoyé des messages actuellement non lus dans cette conversation dans le dossier actuel. Cet élément est en lecture seule. 
