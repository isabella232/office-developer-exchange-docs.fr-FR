...
L’élément **UniqueUnreadSenders** contient la liste de toutes les personnes qui ont envoyé des messages non lus dans cette conversation dans le dossier actif. Cet élément est en lecture seule. 
