...
L’élément **UploadItemsResponseMessage** contient l’état et les résultats d’une demande pour télécharger un élément de boîte aux lettres unique. 
...
|[ID d’élément](itemid.md) <br/> |Contient l’identificateur d’élément d’un élément téléchargé.  <br/> |
