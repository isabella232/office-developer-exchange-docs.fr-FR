...
---
# <a name="user-mailboxassociationtype"></a>Utilisateur (MailboxAssociationType)

L’élément de **l’utilisateur (MailboxAssociationType)** est destiné à usage interne uniquement. 
