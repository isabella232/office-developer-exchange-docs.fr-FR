...
L’élément [UserSetting (SOAP)](usersetting-soap.md) représente un paramètre d’utilisateur unique. 
...
|**Élément**|**Description**|
|:-----|:-----|
|[Nom (SOAP)](name-soap.md) <br/> |Représente le nom du paramètre de l’utilisateur.  <br/> |
