...
---
# <a name="value-extendedattributetype"></a>Valeur (ExtendedAttributeType)

L’élément de **valeur (ExendedAttributeType)** est destiné à une utilisation interne uniquement. 
