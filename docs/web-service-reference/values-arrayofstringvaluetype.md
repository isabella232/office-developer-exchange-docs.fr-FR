...
---
# <a name="values-arrayofstringvaluetype"></a>Valeurs (ArrayOfStringValueType)

L’élément de **valeurs** spécifie les valeurs dans un tableau de propriétés personnage associé à un tableau des attributions. 
