...
L’élément [WebClientUrlCollectionSetting (SOAP)](webclienturlcollectionsetting-soap.md) représente un utilisateur de paramètre qui est une collection d’URL de client Web Exchange. 
