...
L’élément **WeddingAnniversaries** spécifie un tableau de dates d’anniversaire de mariage, stockées sous forme de chaînes et les identificateurs de leurs attributions source pour le personnage associé. 
