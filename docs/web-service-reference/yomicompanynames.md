...
L’élément **YomiCompanyNames** spécifie un tableau de noms de société phonétique et les identificateurs de leurs attributions source pour le personnage associé. 
