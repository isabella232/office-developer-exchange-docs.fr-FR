...
L’élément **YomiLastNames** spécifie un tableau de noms phonétiques (japonais) et les identificateurs de leurs attributions source pour le personnage associé. 
